    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-actions">
                ...
                <a href="reports.jsp" class="btn btn-secondary">Reports</a>
                ...
                <tr>
                    ...
                    <td>
                        <div class="table-actions">
                            ...
                            <form action="AdminServlet" method="POST" class="action-form" onsubmit="return confirm('Remove this librarian?');">
                                <input type="hidden" name="action" value="removeLibrarian">
                                <input type="hidden" name="librarianId" value="<%= lib.getId() %>">
